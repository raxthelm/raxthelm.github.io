...
* [Cman - subproject](https://seamless-learning.eu/en/projekte/cman){:target="_blank"} in the [IBH-Lab "Seamless Learning"](http://www.bodenseehochschule.org/ibh-labs/ibh-lab-seamless-learning/){:target="_blank"}, 2018 - 2020 [-> the Cman-page](http://www-home.htwg-konstanz.de/~raxthelm/Cman/){:target="_blank"}
